...
function DashboardPage() {
  ...
  return (
    <AppShell
      ...
      subtitle="Latest collection from corp.local — LDAP + DACL enumeration"
    ...
    >
      <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
        ...
        <StatTile
          ...
          hint={`${counts("user")} users · ${counts("computer")} hosts · ${counts("group")} groups`}
        />
      </div>

      <div className="mt-4 grid gap-4 lg:grid-cols-3">
        <Panel title="Risk trend (8 weeks)" className="lg:col-span-2">
          <div className="h-64">
